    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">{isAdmin ? `${complaints.length} total � ${complaints.filter(c => c.status === "pending").length} pending` : "View and raise society complaints"}</p>
        </div>
        {canRaise && (
